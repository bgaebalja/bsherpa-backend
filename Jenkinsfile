            ...
            steps {
                script {
                    withCredentials([
                        ...
                        string(credentialsId: 'TSHERPA_API_GET_CHAPTER_ITEM_IMAGES_URL', variable: 'TSHERPA_API_GET_CHAPTER_ITEM_IMAGES_URL'),
                        string(credentialsId: 'TSHERPA_API_GET_EXAM_ITEMS_URL', variable: 'TSHERPA_API_GET_EXAM_ITEMS_URL'),
                        string(credentialsId: 'TSHERPA_API_GET_EXAM_ITEM_IMAGES_URL', variable: 'TSHERPA_API_GET_EXAM_ITEM_IMAGES_URL'),
                        string(credentialsId: 'TSHERPA_API_GET_SIMILAR_ITEMS_URL', variable: 'TSHERPA_API_GET_SIMILAR_ITEMS_URL'),
                        string(credentialsId: 'TSHERPA_API_GET_SIMILAR_ITEM_IMAGES_URL', variable: 'TSHERPA_API_GET_SIMILAR_ITEM_IMAGES_URL'),
                        string(credentialsId: 'TSHERPA_API_GET_ITEM_COUNTS_URL', variable: 'TSHERPA_API_GET_ITEM_COUNTS_URL'),
                        ...
                        string(credentialsId: 'TSHERPA_API_GET_EXAM_ITEM_CLASSIFICATION_PREVIEW_URL', variable: 'TSHERPA_API_GET_EXAM_ITEM_CLASSIFICATION_PREVIEW_URL')
                    ]) {
                        sh '''
                        #!/bin/bash
                        ...
                        ssh -i "$EC2_DEPLOY_KEY_FOR_BSHERPA" ubuntu@"$EC2_IP_FOR_BSHERPA" << EOF
                            ...
                            export TSHERPA_API_GET_CHAPTER_ITEM_IMAGES_URL='$TSHERPA_API_GET_CHAPTER_ITEM_IMAGES_URL'
                            export TSHERPA_API_GET_EXAM_ITEMS_URL='$TSHERPA_API_GET_EXAM_ITEMS_URL'
                            export TSHERPA_API_GET_EXAM_ITEM_IMAGES_URL='$TSHERPA_API_GET_EXAM_ITEM_IMAGES_URL'
                            export TSHERPA_API_GET_SIMILAR_ITEMS_URL='$TSHERPA_API_GET_SIMILAR_ITEMS_URL'
                            export TSHERPA_API_GET_SIMILAR_ITEM_IMAGES_URL='$TSHERPA_API_GET_SIMILAR_ITEM_IMAGES_URL'
                            export TSHERPA_API_GET_ITEM_COUNTS_URL='$TSHERPA_API_GET_ITEM_COUNTS_URL'
                            export TSHERPA_API_GET_CHAPTERS_URL='$TSHERPA_API_GET_CHAPTERS_URL'
                            ...
                            export TSHERPA_API_GET_EXAM_ITEM_CLASSIFICATION_PREVIEW_URL='$TSHERPA_API_GET_EXAM_ITEM_CLASSIFICATION_PREVIEW_URL'
